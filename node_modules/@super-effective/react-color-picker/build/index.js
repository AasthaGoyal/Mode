...
var HueSlider = function HueSlider(_ref) {
  ...
  var _useState = React.useState(false),
      ...
      setIsInteracting = _useState2[1];

  var sliderDivRef = React.useRef();
  var hueColor = hsvToHex(hue, 1, 1);
  var updateHue = React.useCallback(function (evt) {
    var huePosition = getPagePosition(sliderDivRef.current);

    switch (layout) {
      case HueSlider.LAYOUTS.VERTICAL:
        {
          var y = evt.pageY - huePosition.top;
      ...
      default:
        {
          ...
          var _updatedHue = getHueFromPosition(x, sliderDivRef.current.clientWidth);
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", _extends({
    className: classNames__default['default'](styles.hue_slider, className, _defineProperty({}, styles.vertical, layout === HueSlider.LAYOUTS.VERTICAL)),
    ref: sliderDivRef,
    title: "Hue"
  }, interactionCallbacks), /*#__PURE__*/React__default['default'].createElement("div", {
...
HueSlider.propTypes = {
  ...
  hue: PropTypes__default['default'].number.isRequired,
  layout: PropTypes__default['default'].oneOf(Object.values(HueSlider.LAYOUTS)),
  onChange: PropTypes__default['default'].func.isRequired,
  onInteractionStart: PropTypes__default['default'].func,
  onInteractionEnd: PropTypes__default['default'].func
};
...
var SaturationValueSelector = function SaturationValueSelector(_ref) {
  var className = _ref.className,
      hue = _ref.hue,
  ...
  var selectorDivRef = React.useRef();
  var hueColor = hsvToHex(hue, 1, 1);
  var hex = hsvToHex(hue, saturation, value);
  var updateSaturationValue = React.useCallback(function (evt) {
    var svPosition = getPagePosition(selectorDivRef.current);
    var x = evt.pageX - svPosition.left;
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", _extends({
    className: classNames__default['default'](styles$1.saturation_value_selector, className),
    style: {
      backgroundColor: hueColor
    },
    ref: selectorDivRef,
    ...
    className: styles$1.saturation_value_picker,
    style: {
...
SaturationValueSelector.propTypes = {
  className: PropTypes__default['default'].string,
  hue: PropTypes__default['default'].number.isRequired,
  saturation: PropTypes__default['default'].number.isRequired,
...
var ReactColorPicker = function ReactColorPicker(_ref) {
  ...
  var _useState5 = React.useState(false),
      ...
      isInteracting = _useState6[0],
      setIsInteracting = _useState6[1]; // Used when editing the hex through the input


  var _useState7 = React.useState(hex),
      _useState8 = _slicedToArray(_useState7, 2),
      tempHex = _useState8[0],
      setTempHex = _useState8[1];

  var hsvRef = React.useRef(hsv);
  var hexRef = React.useRef(hex); // Set the hex and hsv states/refs with updated data
  ...
  var onControlInteractionStart = function onControlInteractionStart() {
    setIsInteracting(true);
    onInteractionStart();
  };

  var onControlInteractionEnd = function onControlInteractionEnd() {
    setIsInteracting(false);
    onInteractionEnd();
  ...
  var hue = hsv.hue,
      ...
      value = hsv.value;
  return /*#__PURE__*/React__default['default'].createElement("div", _extends({
    className: "".concat(styles$2.react_color_picker).concat(className ? " ".concat(className) : '')
  }, rest), /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$2.saturation_value_selector
  }, /*#__PURE__*/React__default['default'].createElement(SaturationValueSelector, {
    hue: hue,
    saturation: saturation,
    value: value,
    onChange: function onChange(updatedSaturationValue) {
      return setColorFromHsv(_objectSpread2(_objectSpread2({}, hsvRef.current), updatedSaturationValue));
    },
    onInteractionStart: onControlInteractionStart,
    onInteractionEnd: onControlInteractionEnd
  })), /*#__PURE__*/React__default['default'].createElement(HueSlider, {
    hue: hue,
    onChange: function onChange(updatedHue) {
      return setColorFromHsv(_objectSpread2(_objectSpread2({}, hsvRef.current), {}, {
        hue: updatedHue
      }));
    },
    onInteractionStart: onControlInteractionStart,
    onInteractionEnd: onControlInteractionEnd
  }), (showHex || showSwatch) && /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$2.details
  }, showSwatch && /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$2.swatch,
    style: {
      backgroundColor: hex
    },
    title: "Swatch"
  }), showHex && /*#__PURE__*/React__default['default'].createElement("label", null, /*#__PURE__*/React__default['default'].createElement("span", null, "Hex:"), /*#__PURE__*/React__default['default'].createElement("input", {
    className: styles$2.hex_value,
    value: tempHex,
...
ReactColorPicker.propTypes = {
  ...
  showSwatch: PropTypes__default['default'].bool,
  showHex: PropTypes__default['default'].bool,
